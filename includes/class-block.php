...
final class WC_Gateway_Blocks_LokiPays extends AbstractPaymentMethodType {
    ...
    public function initialize() {
        ...
        $this->gateway = new WC_Gateway_Lokipays();
    }
    ...
    public function get_payment_method_script_handles() {
        ...
        wp_register_script(
            ...
            plugin_dir_url(__FILE__) . '/assets/payment-block.js',
            [
                'wc-blocks-registry',
                'wc-settings',
                'wp-element',
